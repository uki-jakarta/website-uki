...
<html>
    <head>
        ...
        <!-- Yamm!3 -->
        <link href="assets/yamm/css/yamm.css" rel="stylesheet" type="text/css"/>
        <!-- Custom -->
    ...
    <body>
        <header>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3">
                            ...
                            <a class="sublink" href="#"><i class="fa fa-pinterest" aria-hidden="true"></i></a>
                        </div>
            ...
            <nav class="navbar navbar-toggleable-md navbar-light bg-faded">
                ...
                <a class="navbar-brand" href="#"><img src="assets/img/logo-utama.png" width="250" alt="Logo UKI"></a>

                <div class="collapse navbar-collapse offset-lg-2" id="miniUKI">
                    <ul class="navbar-nav">
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-sm-12">
                                            ...
                                            <a class="dropdown-item item-head" href="#">Manajemen Perpajakan</a>
                                            <a class="dropdown-item item-head" href="#">Akuntansi</a>
                                            <a class="dropdown-item item-head" href="#">Bahasa Inggris</a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menulink" href="#">Admisi</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menulink" href="#">Beasiswa</a>
                        </li>
                        <li class="nav-item">
        ...
        <div id="footer" class="navbar-nav dark-primary-color">
            <center>
                <p>Copyright &copy; 2017 Universitas Kristen Indonesia</p>
            </center>
        </div>
    </body>
</html>
