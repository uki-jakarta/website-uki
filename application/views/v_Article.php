        ...
        <div class="col-lg-8 col-md-12">
            ...
            <div class="page-content">
                ...
                <div class="page-image">
                    <img class="img-thumbnail mx-auto d-block" src="<?php $image = json_decode($articledetail['image']);
echo $image->url; ?>" alt="<?php echo $articledetail['judul']; ?>">
                </div>
                ...
                if (count($additionalimages) > 0) {
                    ...
                    foreach ($additionalimages as $k => $v) {
                        echo '<a href="' . $v->url . '" data-lightbox="' . $articledetail['id_artikel'] . '" data-title="' . $v->caption . '"><img class="card-img img-thumbnail additional-img-thumbnail" src="' . $v->url . '" alt="' . $v->caption . '"></a>';
                    }
                    echo '</div>';
                }
                ?>
                ...
                <div class="social-media-sharing">
                    ...
                    <ul class="list-unstyled list-inline">
                        <li class="list-inline-item"><a href="<?php echo "https://www.facebook.com/sharer.php?u=".base_url('/artikel/list_artikel/' . $articledetail['slug']).""; ?>"  rel="nofollow"><i class="fa fa-facebook-official fa-2x mod-facebook" aria-hidden="true"></i></a></li>
                        <li class="list-inline-item"><a href="<?php echo "https://twitter.com/intent/tweet?url=".base_url('/artikel/list_artikel/' . $articledetail['slug'])."&text=".$articledetail['judul'].""; ?>" rel="nofollow"><i class="fa fa-twitter fa-2x mod-twitter" aria-hidden="true"></i></a></li>
                        <li class="list-inline-item"><a href="<?php echo "mailto:?subject=".$articledetail['judul']."&body=Check out this site ".base_url('/artikel/list_artikel/' . $articledetail['slug']); ?>" rel="nofollow"><i class="fa fa-envelope-o fa-2x" aria-hidden="true"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
