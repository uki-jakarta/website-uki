...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" id="theme-style" href="<?php echo base_url("assets/css/"); ?>app-blue.css">
    </head>
<body>
                ...
                <aside class="sidebar sidebar-static">
                    <div class="sidebar-container">
                        <div class="sidebar-header">
                            <div class="brand">
                                <img width="100%" src="<?php echo base_url("assets/img/"); ?>logo-uki-admin.png">
                            </div>
                        </div>
                        <nav class="menu">
                            <ul class="nav metismenu" id="sidebar-menu">
                                <li class="<?php if ($page=='dashboard') echo 'active'; ?>"> 
                                    <a href="<?php echo WEBSITE_ADMIN_URL.'Dashboard'; ?>"><i class="fa fa-home"></i> Dashboard
                                    </a>
                                </li>
                            </ul>
                            <ul class="nav metismenu" id="sidebar-menu">
                                <li class="<?php if ($page=='pages') echo 'active'; ?>"> 
                                    <a href="<?php echo WEBSITE_ADMIN_URL.'Pages'; ?>"><i class="fa fa-home"></i> Pages
                                    </a>
                                </li>
                            </ul>
                        </nav>
